...
Although it has been used --- together with the previously discussed \nameref{subsec:req_func} --- as a reference for the project implementation, unforeseen difficulties have caused the development to drift considerably from the plan.
